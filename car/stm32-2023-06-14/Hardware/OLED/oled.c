...
//*******************电机D的PWM值和编码器值********************//
		...
		//=============第6行显示模式和电压=======================//
		 ...
		 if(Voltage%100<10) 	OLED_ShowNumber(17,50,0,2,12);
		  ...
		  OLED_ShowNumber(76,50,RED_KEY,1,12);
	
		  OLED_ShowNumber(112,50,Start_Flag,1,12);
		  OLED_ShowNumber(120,50,Start_Flag_one,1,12);		
...
{ 	
  RCC->APB2ENR|=1<<4;     	//使能PORTC时钟  
	...
	GPIOC->CRH&=0X0000FFFF;	//PC13,14,15设置成输出 2MHz 推挽输出   

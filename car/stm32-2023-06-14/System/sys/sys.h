...
extern u8 Start_Flag,Start_Flag_one; //启动标志
...
extern u8 send_buf[66];
extern u8 FLAG_USART,USART1_data[55], i_u ;

extern float data_u[15];
extern u16 FLAG_USART_ON;

extern u8 FLAG_CAN,txbuf[8],rxbuf[8],Rxbuf[16];
extern float line_KP,line_KD; //直线行走控制PD参数

extern float Velocity_B_KP,Velocity_B_KI;         //电机B速度控制PI参数
/////////////////////////////////////////////////////////////////  
